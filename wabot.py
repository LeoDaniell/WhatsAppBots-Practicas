...
7. group - create a group with the bot"""
    ...
    #Función me, muestra info del interlocutor.
    def me(self, chatID, name):
        return self.send_message(chatID, name)
    #Función file, envía un archivo con el formato especificado a la caja de diálogo
    ...
    #Función ptt, envía un mensaje de voz a una conversación.
    def ptt(self, chatID):        
            data = {
            "audio" : 'https://domain.com/Python/ptt.ogg',
            "chatId" : chatID }
            return self.send_requests('sendAudio', data)
    #Función geo, envía coordenadas.
    def geo(self, chatID):
        data = {
                "lat" : '51.51916',
                "lng" : '-0.139214',
        ...
        return answer
    #Función group, Cree un grupo para usted mismo y el bot.
